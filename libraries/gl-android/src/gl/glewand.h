...
// TODO - to make it build, review then
#ifndef GLAPI
#define GLAPI extern
#endif
...
/* Implemented in open gl es 2 !? GLAPI GLenum GLAPIENTRY glGetError (void); */
...
#define glewInit() glewContextInit(NULL)
